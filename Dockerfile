...
COPY --chown=shiny ./ ./
# renv restore
# TODO running R (Rscript, below) invokes renv/activate.R, which ensures renv is available
# TODO So we should not have to install the renv package.  Does the build work with the following
# TODO line removed?

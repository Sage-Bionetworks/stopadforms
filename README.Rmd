...
Below is an example of how to calculate scores for a submission outside of the
Shiny app (i.e. in an R script). This example uses sample data included in the
package.


```{r self-contained-scoring-example}
library("stopadforms")
...
Below is a more real-world example that shows how to score submissions that are
stored by Synapse. To run this, you will need to have Python and the
